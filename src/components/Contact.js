...
import email from "../at-sign.svg";
import pindrop from "../map-pin.svg";
...
<footer aria-label="Site Footer" className={"  " +(props.theme==="dark"?  "bg-gradient-to-r  from-[#42275a] to-[#734b6d] ": " bg-gradient-to-r  from-[#be93c5] to-[#7bc6cc] ")}>
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 initiatedBy" id='contactTyper1'>
                  
                </p>

                <nav aria-label="Footer Nav" className="mt-12 w-full">
                    <ul className="container justify-center gap-6 md:gap-8 lg:gap-12">
                       
                        <li className='mx-auto my-5 flex flex-wrap w-fit'>
                            <img src= {email} className='px-1' alt='' /> 
                            <span>22devendrabijwe@gmail.com</span>
                       
                        </li>

                       
                        <li className='mx-auto my-5 flex flex-wrap w-fit'>
                            <img src= {phone} className='px-1' alt='' /> 
                            <span>7666230646</span>
                        </li>

                        <li className='mx-auto my-5 flex flex-wrap w-fit'>
                            <img src= {pindrop} className='px-1' alt='' /> 
                            <span>Yavatmal, MH</span>
                        </li>
