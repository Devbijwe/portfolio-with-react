...
<nav className="bg-white navigation shadow fixed z-10 w-screen dark:bg-gray-800" id="nav">
    <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <a href="#home" id='navItem1'  onClick={handleNavClick("home")} className="navItem hover:text-gray-800 dark:text-gray-200 border-b-2 border-transparent hover:border-blue-500 mx-1.5 sm:mx-6">home</a>

        <a href="#skills" id='navItem2'  onClick={handleNavClick("skills")} className="navItem border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">My Skills</a>

        <a href="#projects" id='navItem3'  onClick={handleNavClick("projects")} className="navItem border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Projects</a>

        <a href="#contacts" id='navItem4' onClick={handleNavClick("contacts")} className="navItem border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Contacts</a>

        {/* <a href="#frvr" className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">
        ...
        <a href="#effefef" className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">
    ...
    {/* <nav className="navigation fixed z-10" id="nav">
  <ul>
    <li className="blue active"><a href="#home">Home</a></li>
    <li className="green "><a href="#skills">Skills</a></li>
    <li className="orange"><a href="#page3">Page 3</a></li>
    <li className="yellow"><a href="#page4">Page 4</a></li>
  </ul>
</nav> */}
    
    
<div className="top-page bg-gray-100 align-middle justify-center text-center items-center h-screen" id="home" >
<Home/>
</div>
